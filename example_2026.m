...
fprintf('maximum lateral deflection   = %7.4f in (case %i)', sway, swayID)
max_lateral_sway = 0.75;
if (sway > max_lateral_sway)
    fprintf(' - WARNING: Exceeded maximum allowable sway (%7.4f in)\n', max_lateral_sway)
else
    fprintf('\n')
end
